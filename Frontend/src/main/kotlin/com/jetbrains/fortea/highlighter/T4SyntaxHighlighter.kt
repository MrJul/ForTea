...
object T4SyntaxHighlighter : SyntaxHighlighterBase() {
  ...
  val EQ = createTextAttributesKey("T4_DIRECTIVE_EQ_SIGN", DefaultLanguageHighlighterColors.OPERATION_SIGN)
  ...
  private val EQ_KEYS = arrayOf(EQ)
  ...
  override fun getTokenHighlights(elementType: IElementType?): Array<TextAttributesKey> = when (elementType) {
    ...
    T4ElementTypes.CODE_BLOCK_START -> BLOCK_MARKER_KEYS
    T4ElementTypes.DIRECTIVE_START -> BLOCK_MARKER_KEYS
    T4ElementTypes.EQ -> EQ_KEYS
