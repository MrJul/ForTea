...
object T4SyntaxHighlighter : SyntaxHighlighterBase() {
  ...
  val DIRECTIVE_NAME =
    createTextAttributesKey("T4_ATTRIBUTE", DefaultLanguageHighlighterColors.REASSIGNED_LOCAL_VARIABLE)
  val ATTRIBUTE_KEY = createTextAttributesKey("T4_ATTRIBUTE_KEY", DefaultLanguageHighlighterColors.LOCAL_VARIABLE)
