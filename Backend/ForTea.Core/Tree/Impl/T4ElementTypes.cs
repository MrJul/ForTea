...
namespace GammaJul.ForTea.Core.Tree.Impl {
	...
	public static class T4ElementTypes {
		...
		[NotNull] public static readonly CompositeNodeType T4Text = new T4CompositeNodeType<T4Text>(2009);
		[NotNull] public static readonly CompositeNodeType T4AttributeValue = new T4CompositeNodeType<T4AttributeValue>(2009);
